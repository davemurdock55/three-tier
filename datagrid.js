...
let prefix = "https://script.google.com/macros/s/AKfycbxWdZkoYTcOIrepDK786msalz3w1NbdkIgN4TxttP6-opW81YiIcabZBbMOVokhdKI/exec";
...
{ // is triggered when a user changes a value in a cell of the table
    ...
    switch (params[0])
    {                                   // Presentation layer data validation. params[0] is the table name
        case "Employee":                                 // validating fields in the employee table  
            switch (params[2])
            {                           // params[2] is the field name 
